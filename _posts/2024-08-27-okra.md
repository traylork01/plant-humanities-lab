...
{% include embed/image.html src="profdrthomsflora03thom_0644.jpg" caption="Flora von Deutschland. Botanical illustration from Thomé's Natural History." description="Botanical illustration from Thomé's Natural History" license="CC BY-SA 4.0" aspect="0.65" %}
...
{% include embed/map.html center="6.66461,-34.45313" zoom="2" caption="Migration from Africa to the Southern States. Allison Caban and Malek Charchou, ArcGIS, 2024." markers="|" geojson="American_South_Overlay.json|arrows.json" %}
